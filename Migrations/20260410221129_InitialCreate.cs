        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailOtpCode = table.Column<string>(type: "TEXT", maxLength: 12, nullable: false),
                    EmailOtpExpiresAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    InstitutionFullAddress = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    ...
                    VerifiedBy = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    VerifiedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsSuspicious = table.Column<bool>(type: "INTEGER", nullable: false),
                    RiskNotes = table.Column<string>(type: "TEXT", maxLength: 800, nullable: false),
                    InternalReviewStatus = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    InternalReviewNotes = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: false),
                    ...
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    SubmissionToken = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
